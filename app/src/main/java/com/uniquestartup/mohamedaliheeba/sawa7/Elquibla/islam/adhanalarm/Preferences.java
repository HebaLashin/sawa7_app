package com.uniquestartup.mohamedaliheeba.sawa7.Elquibla.islam.adhanalarm;

import static com.uniquestartup.mohamedaliheeba.sawa7.Elquibla.net.sourceforge.jitl.astro.Location.DEFAULT_PRESSURE;
import static com.uniquestartup.mohamedaliheeba.sawa7.Elquibla.net.sourceforge.jitl.astro.Location.DEFAULT_SEA_LEVEL;
import static com.uniquestartup.mohamedaliheeba.sawa7.Elquibla.net.sourceforge.jitl.astro.Location.DEFAULT_TEMPERATURE;
...
//            Utils.updateWidgets(context);
    ...
    public com.uniquestartup.mohamedaliheeba.sawa7.Elquibla.net.sourceforge.jitl.astro.Location getJitlLocation() {
        final float[] latLong = getLocation();
        com.uniquestartup.mohamedaliheeba.sawa7.Elquibla.net.sourceforge.jitl.astro.Location location = new com.uniquestartup.mohamedaliheeba.sawa7.Elquibla.net.sourceforge.jitl.astro.Location(
