...
import com.uniquestartup.mohamedaliheeba.sawa7.UnitConverter.Currencypackage.*;
...
public class CurrencyActivity extends ActionBarActivity {
        ...
        mCurrencyList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (mCurrencyEditText.getText().toString().isEmpty()) {
                    ...
                    Intent intent = new Intent(CurrencyActivity.this, DisplayCurrencyActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_currency_main, menu);
        return true;
    }
                    ...
                    mCurrencyService.getRates(key, new Callback<RateResponse>() {
                        ...
                        public void success(RateResponse rateResponse, Response response) {
                            ...
                            if (mCurrencyMappings != null) {
                                ...
                                mCurrencyAdapter = new CurrencyAdapter(CurrencyActivity.this);
                                mCurrencyList.setAdapter(mCurrencyAdapter);
