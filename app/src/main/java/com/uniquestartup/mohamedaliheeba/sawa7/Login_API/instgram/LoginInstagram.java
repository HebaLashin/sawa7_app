package com.uniquestartup.mohamedaliheeba.sawa7.Login_API.instgram;
...
import com.uniquestartup.mohamedaliheeba.sawa7.Login_API.instgram.InstagramApp.OAuthAuthenticationListener;
import com.uniquestartup.mohamedaliheeba.sawa7.activity.ProfileActivity;
import com.uniquestartup.mohamedaliheeba.sawa7.lazyload.ImageLoader;
import com.uniquestartup.mohamedaliheeba.sawa7.R;


public class LoginInstagram extends Activity implements OnClickListener {
    ...
    private Handler handler = new Handler(new Callback() {
        ...
        public boolean handleMessage(Message msg) {
            if (msg.what == InstagramApp.WHAT_FINALIZE) {
                ...
                Toast.makeText(LoginInstagram.this, "Check your network.",
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mApp.setListener(new OAuthAuthenticationListener() {
            ...
            public void onFail(String error) {
                Toast.makeText(LoginInstagram.this, error, Toast.LENGTH_SHORT)
                        .show();
            }
        });
        setWidgetReference();
...
//        btnViewInfo.setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (v == btnConnect) {
            ...
            startActivity(new Intent(LoginInstagram.this, AllMediaFiles.class)
            ...
            startActivity(new Intent(LoginInstagram.this, Relationship.class)
    ...
    private void displayInfoDialogView() {
        ...
        new ImageLoader(LoginInstagram.this).DisplayImage(
    ...
    private void nextActivityme() {
        ...
        Intent main = new Intent(LoginInstagram.this, ProfileActivity.class);
