...
/**
 * Created by Moham on 30/09/2016.
 */

public class FullDrawerLayout extends NavigationView {
    ...
    public FullDrawerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
